...
def insert_and_search_example():
    ...
    node400 = Node(400)
    #level 4
    node80 = Node(80, leaf =True)
    node87 = Node(87, True)
    node92 = Node(92, True)
    node98 = Node(98, True)
    node120 = Node(120, True)
    node170 = Node(170, True)
    node250 = Node(250, True)
    node450 = Node(450, True)

    # insert level 2 
    node90.children = [node85, node95]
    node200.children = [node150, node400]
    # insert level 3
    node85.children = [80, 87]
    node95.children = [node92, node98]
    node150.children = [node120, node170]
    node400.children = [node250, node450]

    leftLeftLeftLeaf = [80]
    leftLeftRightLeaf = [87]
    leftRightLeftLeaf = [92]
    


    B = BTree(100)
    B.t = 2
    B.root.children = [node90 , node200]
